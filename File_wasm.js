...
function _getWasmBinary() {
    _getWasmBinary = _asyncToGenerator(
        _regeneratorRuntime().mark(function _callee4(binaryFile) {
            var response;
...
function _instantiateArrayBuffer() {
    _instantiateArrayBuffer = _asyncToGenerator(
        _regeneratorRuntime().mark(function _callee5(binaryFile, imports) {
            var binary, instance;
            return _regeneratorRuntime().wrap(
                    ...
                    while (1)
                        switch ((_context5.prev = _context5.next)) {
                            ...
                            case 10:
                                ...
                                err(
                                    "failed to asynchronously prepare wasm: ".concat(
                                        _context5.t0
                                    )
                                );
                                abort(_context5.t0);
...
function _instantiateAsync() {
    _instantiateAsync = _asyncToGenerator(
                    ...
                    while (1)
                        switch ((_context6.prev = _context6.next)) {
                            ...
                            case 9:
                                ...
                                err(
                                    "wasm streaming compile failed: ".concat(
                                        _context6.t0
                                    )
                                );
                                err(
                            ...
                            case 13:
                                return _context6.abrupt(
                                    "return",
                                    instantiateArrayBuffer(binaryFile, imports)
                                );
                            case 14:
                            case "end":
            ...
            return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1)
                    switch ((_context7.prev = _context7.next)) {
                        case 0:
                            receiveInstantiationResult =
                                function _receiveInstantiation(result) {
                                    return receiveInstance(result["instance"]);
                                };
                            receiveInstance = function _receiveInstance(
                                instance,
                                module
                            ) {
                        ...
                        case 6:
                            wasmBinaryFile !== null && wasmBinaryFile !== void 0
                                ? wasmBinaryFile
...
var ___assert_fail = function ___assert_fail(condition, filename, line, func) {
    return abort(
        "Assertion failed: ".concat(UTF8ToString(condition), ", at: ") +
        [
...
var stringToUTF8Array = function stringToUTF8Array(
    str,
    heap,
    outIdx,
    maxBytesToWrite
...
var intArrayFromString = function intArrayFromString(
    stringy,
    dontAddNull,
    length
) {
...
var TTY = {
    ...
    default_tty_ops: {
        ...
        fsync(tty) {
            var _tty$output;
            if (
                ((_tty$output = tty.output) === null || _tty$output === void 0
                    ? void 0
                    : _tty$output.length) > 0
            ) {
                out(UTF8ArrayToString(tty.output));
                tty.output = [];
            }
    ...
    default_tty1_ops: {
        ...
        fsync(tty) {
            var _tty$output2;
            if (
                ((_tty$output2 = tty.output) === null || _tty$output2 === void 0
                    ? void 0
                    : _tty$output2.length) > 0
            ) {
                err(UTF8ArrayToString(tty.output));
                tty.output = [];
            }
...
GameGlobal.MEMFS = {
    ...
    node_ops: {
        ...
        readdir(node) {
            return [".", ".."].concat(
                _toConsumableArray(Object.keys(node.contents))
            );
        },
...
var FS_createDataFile = function FS_createDataFile(
    parent,
    name,
    fileData,
    canRead,
...
var FS_handledByPreloadPlugin = function FS_handledByPreloadPlugin(
    byteArray,
    fullname,
    finish,
    onerror
...
var FS_createPreloadedFile = function FS_createPreloadedFile(
    parent,
    name,
    url,
    canRead,
    ...
    function processData(byteArray) {
        ...
        if (
            FS_handledByPreloadPlugin(byteArray, fullname, finish, function () {
...
GameGlobal.FS = {
    ...
    lookupPath(path) {
        ...
        (_opts$follow_mount = opts.follow_mount) !== null &&
            _opts$follow_mount !== void 0
            ? _opts$follow_mount
        ...
        linkloop: for (var nlinks = 0; nlinks < 40; nlinks++) {
            ...
            for (var i = 0; i < parts.length; i++) {
                ...
                try {
                    ...
                    if (
                        (e === null || e === void 0 ? void 0 : e.errno) ===
                        44 &&
                        islast &&
                        opts.noent_okay
                    ) {
    ...
    doSetAttr(stream, node, attr) {
        var setattr =
            stream === null || stream === void 0
                ? void 0
                : stream.stream_ops.setattr;
        var arg = setattr ? stream : node;
        setattr !== null && setattr !== void 0
            ? setattr
    ...
    readFile(path) {
        ...
        if (opts.encoding !== "utf8" && opts.encoding !== "binary") {
            throw new Error(
                'Invalid encoding type "'.concat(opts.encoding, '"')
            );
        }
        var ret;
...
var ___syscall__newselect = function ___syscall__newselect(
    nfds,
    readfds,
    writefds,
    exceptfds,
...
var SOCKFS = {
    ...
    emit(event, param) {
        ...
        (_SOCKFS$callbacks$eve = (_SOCKFS$callbacks = SOCKFS.callbacks)[
            event
        ]) === null ||
            _SOCKFS$callbacks$eve === void 0 ||
            _SOCKFS$callbacks$eve.call(_SOCKFS$callbacks, param);
    },
    mount(mount) {
        var _websocket, _Module$_websocket;
        SOCKFS.websocketArgs = Module["websocket"] || {};
        ((_Module$_websocket = Module[(_websocket = "websocket")]) !== null &&
            _Module$_websocket !== void 0
            ? _Module$_websocket
            : (Module[_websocket] = {}))["on"] = SOCKFS.on;
    ...
    websocket_sock_ops: {
        ...
        close(sock) {
            ...
            for (
                var _i2 = 0, _Object$values = Object.values(sock.peers);
...
function _dmDeviceJSOpen(bufferCount) {
    ...
    if (window.AudioContext || window.webkitAudioContext) {
        if (shared.audioCtx === undefined) {
            ...
            try {
                shared.audioCtx = new audioCtxCtor({ sampleRate: 48e3 });
            } catch (e) {
        ...
        device = {
            ...
            _queue: function _queue(samples, frame_count) {
                ...
                if (
                    this.bufferedTo / this.sampleRate <= t ||
            ...
            _freeBufferSlots: function _freeBufferSlots() {
                ...
                if (this._isContextRunning()) {
                    ...
                    ahead =
                        this.bufferedTo / this.sampleRate -
                        shared.audioCtx.currentTime;
                } else {
                    ahead =
                        this.suspendedBufferedTo -
                        this._getCurrentSuspendedTime();
                }
    ...
    xhr.onprogress = function (progress_event) {
        if (onprogress != 0) {
            getWasmTableEntry(onprogress)(
                arg,
                progress_event.loaded,
                progress_event.total
            );
        }
    };
...
var JSEvents = {
    ...
    runDeferredCalls() {
        ...
        try {
            for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                ...
                (_call = call).targetFunction.apply(
                    _call,
                    _toConsumableArray(call.argsList)
                );
            }
        } catch (err) {
            _iterator4.e(err);
    ...
    eventHandlers: [],
    removeAllHandlersOnTarget: function removeAllHandlersOnTarget(
        target,
        eventTypeString
    ) {
    ...
    getNodeNameForTarget(target) {
        ...
        return (
            (target === null || target === void 0 ? void 0 : target.nodeName) ||
            ""
        );
    },
    fullscreenEnabled() {
            ...
            if (typeof MainLoop.setImmediate == "undefined") {
                if (typeof setImmediate == "undefined") {
                    ...
                    var MainLoop_setImmediate_messageHandler =
                        function MainLoop_setImmediate_messageHandler(event) {
                            if (
                    ...
                    MainLoop.setImmediate = function (func) {
                        ...
                        if (ENVIRONMENT_IS_WORKER) {
                            ...
                            (_Module$_setImmediate =
                                Module[(_setImmediates = "setImmediates")]) !==
                                null && _Module$_setImmediate !== void 0
                                ? _Module$_setImmediate
...
var setMainLoop = function setMainLoop(
    iterFunc,
    fps,
...
var GL = {
    ...
    makeContextCurrent: function makeContextCurrent(contextHandle) {
        ...
        Module["ctx"] = GLctx =
            (_GL$currentContext = GL.currentContext) === null ||
                _GL$currentContext === void 0
                ? void 0
                : _GL$currentContext.GLctx;
    ...
    deleteContext: function deleteContext(contextHandle) {
        ...
        if (
            (_GL$contexts$contextH = GL.contexts[contextHandle]) !== null &&
            _GL$contexts$contextH !== void 0 &&
            _GL$contexts$contextH.GLctx.canvas
        ) {
...
var _glBindAttribLocation = function _glBindAttribLocation(
    program,
    index,
    name
) {
...
var _glBindBufferRange = function _glBindBufferRange(
    target,
    index,
    buffer,
    offset,
...
var _glBlitFramebuffer = function _glBlitFramebuffer(
    x0,
    x1,
    x2,
    x3,
...
var _glClientWaitSync = function _glClientWaitSync(
    sync,
    flags,
    timeout_low,
    timeout_high
...
var _glCompressedTexImage2D = function _glCompressedTexImage2D(
    target,
    level,
    internalFormat,
    width,
...
var _glCompressedTexImage3D = function _glCompressedTexImage3D(
    target,
    level,
    internalFormat,
    width,
...
var _glCompressedTexSubImage2D = function _glCompressedTexSubImage2D(
    target,
    level,
    xoffset,
    yoffset,
...
var _glCompressedTexSubImage3D = function _glCompressedTexSubImage3D(
    target,
    level,
    xoffset,
    yoffset,
...
var _glCopyTexImage2D = function _glCopyTexImage2D(
    x0,
    x1,
    x2,
    x3,
...
var _glCopyTexSubImage2D = function _glCopyTexSubImage2D(
    x0,
    x1,
    x2,
    x3,
...
var _glCopyTexSubImage3D = function _glCopyTexSubImage3D(
    x0,
    x1,
    x2,
    x3,
...
var _glDrawArraysInstanced = function _glDrawArraysInstanced(
    mode,
    first,
    count,
    primcount
...
var _glDrawElementsInstanced = function _glDrawElementsInstanced(
    mode,
    count,
    type,
    indices,
...
var _glDrawRangeElements = function _glDrawRangeElements(
    mode,
    start,
    end,
    count,
...
var _glFramebufferRenderbuffer = function _glFramebufferRenderbuffer(
    target,
    attachment,
    renderbuffertarget,
    renderbuffer
...
var _glFramebufferTexture2D = function _glFramebufferTexture2D(
    target,
    attachment,
    textarget,
    texture,
...
var _glFramebufferTextureLayer = function _glFramebufferTextureLayer(
    target,
    attachment,
    texture,
    level,
...
var __glGetActiveAttribOrUniform = function __glGetActiveAttribOrUniform(
    funcName,
    program,
    index,
    bufSize,
...
var _glGetActiveAttrib = function _glGetActiveAttrib(
    program,
    index,
    bufSize,
    length,
...
var _glGetActiveUniform = function _glGetActiveUniform(
    program,
    index,
    bufSize,
    length,
...
var _glGetActiveUniformBlockName = function _glGetActiveUniformBlockName(
    program,
    uniformBlockIndex,
    bufSize,
    length,
...
var _glGetActiveUniformBlockiv = function _glGetActiveUniformBlockiv(
    program,
    uniformBlockIndex,
    pname,
    params
...
var _glGetActiveUniformsiv = function _glGetActiveUniformsiv(
    program,
    uniformCount,
    uniformIndices,
    pname,
...
var _glGetAttachedShaders = function _glGetAttachedShaders(
    program,
    maxCount,
    count,
    shaders
...
var getEmscriptenSupportedExtensions =
    function getEmscriptenSupportedExtensions(ctx) {
    ...
    if (ret === undefined) {
        ...
        switch (_typeof(result)) {
            ...
            default:
                ...
                err(
                    "GL_INVALID_ENUM in glGet"
                        .concat(type, "v: Native code calling glGet")
                        .concat(type, "v(")
                        .concat(name_, ") and it returns ")
                        .concat(result, " of type ")
                        .concat(_typeof(result), "!")
                );
                return;
        }
    }
...
var _glGetBufferParameteri64v = function _glGetBufferParameteri64v(
    target,
    value,
    data
) {
...
var _glGetBufferParameteriv = function _glGetBufferParameteriv(
    target,
    value,
    data
) {
...
var emscriptenWebGLGetIndexed = function emscriptenWebGLGetIndexed(
    target,
    index,
    data,
    type
...
var _glGetInternalformativ = function _glGetInternalformativ(
    target,
    internalformat,
    pname,
    bufSize,
...
var _glGetProgramBinary = function _glGetProgramBinary(
    program,
    bufSize,
    length,
    binaryFormat,
...
var _glGetProgramInfoLog = function _glGetProgramInfoLog(
    program,
    maxLength,
    length,
    infoLog
...
var _glGetQueryObjecti64vEXT = function _glGetQueryObjecti64vEXT(
    id,
    pname,
    params
) {
...
var _glGetQueryObjectivEXT = function _glGetQueryObjectivEXT(
    id,
    pname,
    params
) {
...
var _glGetRenderbufferParameteriv = function _glGetRenderbufferParameteriv(
    target,
    pname,
    params
) {
...
var _glGetSamplerParameterfv = function _glGetSamplerParameterfv(
    sampler,
    pname,
    params
) {
...
var _glGetShaderInfoLog = function _glGetShaderInfoLog(
    shader,
    maxLength,
    length,
    infoLog
...
var _glGetShaderPrecisionFormat = function _glGetShaderPrecisionFormat(
    shaderType,
    precisionType,
    range,
    precision
...
var _glGetShaderSource = function _glGetShaderSource(
    shader,
    bufSize,
    length,
    source
...
var _glGetTexParameterfv = function _glGetTexParameterfv(
    target,
    pname,
    params
) {
...
var _glGetTexParameteriv = function _glGetTexParameteriv(
    target,
    pname,
    params
) {
...
var _glGetTransformFeedbackVarying = function _glGetTransformFeedbackVarying(
    program,
    index,
    bufSize,
    length,
...
var _glGetUniformBlockIndex = function _glGetUniformBlockIndex(
    program,
    uniformBlockName
) {
...
var _glGetUniformIndices = function _glGetUniformIndices(
    program,
    uniformCount,
    uniformNames,
    uniformIndices
...
var emscriptenWebGLGetUniform = function emscriptenWebGLGetUniform(
    program,
    location,
    params,
    type
...
var emscriptenWebGLGetVertexAttrib = function emscriptenWebGLGetVertexAttrib(
    index,
    pname,
    params,
    type
...
var _glGetVertexAttribIiv = function _glGetVertexAttribIiv(
    index,
    pname,
    params
) {
...
var _glGetVertexAttribPointerv = function _glGetVertexAttribPointerv(
    index,
    pname,
    pointer
) {
...
var _glInvalidateFramebuffer = function _glInvalidateFramebuffer(
    target,
    numAttachments,
    attachments
) {
...
var _glInvalidateSubFramebuffer = function _glInvalidateSubFramebuffer(
    target,
    numAttachments,
    attachments,
    x,
...
var _glPolygonOffsetClampEXT = function _glPolygonOffsetClampEXT(
    factor,
    units,
    clamp
) {
...
var _glProgramBinary = function _glProgramBinary(
    program,
    binaryFormat,
    binary,
    length
...
var _glProgramParameteri = function _glProgramParameteri(
    program,
    pname,
    value
) {
...
var computeUnpackAlignedImageSize = function computeUnpackAlignedImageSize(
    width,
    height,
    sizePerPixel
) {
...
var colorChannelsInGlTextureFormat = function colorChannelsInGlTextureFormat(
    format
) {
    var colorChannels = {
        5: 3,
...
var emscriptenWebGLGetTexPixelData = function emscriptenWebGLGetTexPixelData(
    type,
    format,
    width,
    height,
...
var _glReadPixels = function _glReadPixels(
    x,
    y,
    width,
    height,
...
var _glSamplerParameterf = function _glSamplerParameterf(
    sampler,
    pname,
    param
) {
...
var _glSamplerParameterfv = function _glSamplerParameterfv(
    sampler,
    pname,
    params
) {
...
var _glSamplerParameteri = function _glSamplerParameteri(
    sampler,
    pname,
    param
) {
...
var _glSamplerParameteriv = function _glSamplerParameteriv(
    sampler,
    pname,
    params
) {
...
var _glShaderBinary = function _glShaderBinary(
    count,
    shaders,
    binaryformat,
    binary,
...
var _glTexImage2D = function _glTexImage2D(
    target,
    level,
    internalFormat,
    width,
...
var _glTexImage3D = function _glTexImage3D(
    target,
    level,
    internalFormat,
    width,
...
var _glTexSubImage2D = function _glTexSubImage2D(
    target,
    level,
    xoffset,
    yoffset,
...
var _glTexSubImage3D = function _glTexSubImage3D(
    target,
    level,
    xoffset,
    yoffset,
...
var _glTransformFeedbackVaryings = function _glTransformFeedbackVaryings(
    program,
    count,
    varyings,
    bufferMode
...
var _glUniformBlockBinding = function _glUniformBlockBinding(
    program,
    uniformBlockIndex,
    uniformBlockBinding
) {
...
var _glUniformMatrix2fv = function _glUniformMatrix2fv(
    location,
    count,
    transpose,
    value
...
var _glUniformMatrix2x3fv = function _glUniformMatrix2x3fv(
    location,
    count,
    transpose,
    value
...
var _glUniformMatrix2x4fv = function _glUniformMatrix2x4fv(
    location,
    count,
    transpose,
    value
...
var _glUniformMatrix3fv = function _glUniformMatrix3fv(
    location,
    count,
    transpose,
    value
...
var _glUniformMatrix3x2fv = function _glUniformMatrix3x2fv(
    location,
    count,
    transpose,
    value
...
var _glUniformMatrix3x4fv = function _glUniformMatrix3x4fv(
    location,
    count,
    transpose,
    value
...
var _glUniformMatrix4fv = function _glUniformMatrix4fv(
    location,
    count,
    transpose,
    value
...
var _glUniformMatrix4x2fv = function _glUniformMatrix4x2fv(
    location,
    count,
    transpose,
    value
...
var _glUniformMatrix4x3fv = function _glUniformMatrix4x3fv(
    location,
    count,
    transpose,
    value
...
var _glVertexAttribIPointer = function _glVertexAttribIPointer(
    index,
    size,
    type,
    stride,
...
var _glVertexAttribPointer = function _glVertexAttribPointer(
    index,
    size,
    type,
    normalized,
...
var _emscripten_set_main_loop_arg = function _emscripten_set_main_loop_arg(
    func,
    arg,
    fps,
    simulateInfiniteLoop
    ...
    function webgl_enable_ANGLE_instanced_arrays(ctx) {
        ...
        if (ext) {
            ...
            ctx["drawArraysInstanced"] = function (
                ...
                return ext["drawArraysInstancedANGLE"](
                    mode,
                    first,
                    count,
                    primcount
...
var webgl_enable_WEBGL_draw_buffers = function webgl_enable_WEBGL_draw_buffers(
    ctx
) {
...
var webgl_enable_EXT_polygon_offset_clamp =
    function webgl_enable_EXT_polygon_offset_clamp(ctx) {
        return !!(ctx.extPolygonOffsetClamp = ctx.getExtension(
            "EXT_polygon_offset_clamp"
        ));
    };
var webgl_enable_EXT_clip_control = function webgl_enable_EXT_clip_control(
    ctx
) {
    return !!(ctx.extClipControl = ctx.getExtension("EXT_clip_control"));
};
var webgl_enable_WEBGL_polygon_mode = function webgl_enable_WEBGL_polygon_mode(
    ctx
) {
    return !!(ctx.webglPolygonMode = ctx.getExtension("WEBGL_polygon_mode"));
};
var webgl_enable_WEBGL_multi_draw = function webgl_enable_WEBGL_multi_draw(
    ctx
) {
    return !!(ctx.multiDrawWebgl = ctx.getExtension("WEBGL_multi_draw"));
};
var _emscripten_webgl_enable_extension =
...
var GLFW = {
    ...
    addEventListenerCanvas: function addEventListenerCanvas(
        type,
        listener,
        useCapture
    ) {
    ...
    removeEventListenerCanvas: function removeEventListenerCanvas(
        type,
        listener,
        useCapture
    ) {
    ...
    touchWasFinished: function touchWasFinished(event, phase) {
        ...
        if (
            typeof DefoldSoundDevice != "undefined" &&
            DefoldSoundDevice != null
        ) {
    ...
    convertCoordinatesFromMonitorToWebGLPixels:
        function convertCoordinatesFromMonitorToWebGLPixels(x, y) {
            ...
            if (
                ...
                for (var joy = 0; joy < GLFW.lastGamepadState.length; ++joy) {
                    ...
                    if (gamepad) {
                        ...
                        if (
                            !GLFW.joys[joy] ||
                            GLFW.joys[joy].id_string != gamepad_id
                        ) {
                            if (GLFW.joys[joy]) {
...
var Browser = {
    ...
    init() {
        ...
        audioPlugin["handle"] = function audioPlugin_handle(
            ...
            audio.onerror = function audio_onerror(event) {
                if (done) return;
                err(
                    "warning: browser could not fully decode audio ".concat(
                        name,
    ...
    requestFullscreen(lockPointer, resizeCanvas) {
        ...
        function fullscreenChange() {
            ...
            (_Module$onFullScreen = Module["onFullScreen"]) === null ||
                _Module$onFullScreen === void 0 ||
                _Module$onFullScreen.call(Module, Browser.isFullscreen);
            (_Module$onFullscreen = Module["onFullscreen"]) === null ||
                _Module$onFullscreen === void 0 ||
                _Module$onFullscreen.call(Module, Browser.isFullscreen);
        }
        ...
        canvasContainer.requestFullscreen =
            ...
            (canvasContainer["webkitRequestFullscreen"]
                ? function () {
                    return canvasContainer["webkitRequestFullscreen"](
    ...
    getUserMedia(func) {
        var _window;
        (_window = window).getUserMedia ||
            (_window.getUserMedia =
...
var dmRenderer = {
    ...
    rendererContextEvent: function rendererContextEvent(event_type) {
        if (dmRenderer.renderCallback) {
            getWasmTableEntry(dmRenderer.renderCallback)(
                dmRenderer.renderContext,
                event_type
            );
        }
    },
