...
var EngineLoader = {
    ...
    loadAndInstantiateWasmAsync: function (src, imports, successCallback) {
        var wasmInstantiate = WebAssembly.instantiate(src, imports).then(function (output) {
    ...
    load: function (appCanvasId, exeName, startjs) {
        ...
        CUSTOM_PARAMETERS['startjs'] = startjs;
    ...
    downloadPiece: function (file, index) {
        ...
        FileLoader.load(
            ...
            function (response) {
                ...
                var total = piece.dataLength;
                var downloaded = piece.dataLength;
    ...
    **/
    ...
    preInit: [function () {
        ...
        try {
            ...
            console.warn("Unable to mount persistent data directory: ", error);
